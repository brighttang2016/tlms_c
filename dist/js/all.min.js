...
$templateCache.put('app/module-process/tpl/currTask.html','<div ng-controller="ProcessController">\r\n    \u5F85\u529E\u4EFB\u52A1\u67E5\u8BE2\r\n    <form>\r\n        <input type="button" value="\u5F85\u529E\u4EFB\u52A1\u67E5\u8BE2" ng-click="queryCurrProcess()"/>\r\n    </form>\r\n\r\n    <div>\r\n        <table class="table table-condensed table-bordered">\r\n            <thead>\r\n                <tr>\r\n                    <td>\u6D41\u7A0B\u5B9E\u4F8Bid</td><td>\u6D41\u7A0B\u5B9A\u4E49id</td><td>\u64CD\u4F5C</td>\r\n                </tr>\r\n            </thead>\r\n            <tbody>\r\n            <tr ng-repeat="item in records">\r\n                <td>{{ item.id }}</td>\r\n                <td>{{ item.procDefId }}</td>\r\n                <td>\r\n                    <a ng-click="queryProcessDetail(item.id)">\u6D41\u7A0B\u660E\u7EC6</a>\r\n                </td>\r\n            </tr>\r\n            </tbody>\r\n        </table>\r\n    </div>\r\n    <div ui-view = \'currTaskView\'></div>\r\n</div>');
$templateCache.put('app/module-process/tpl/process.html','<div ng-controller="ProcessController">\r\n    \u6D41\u7A0B\u7BA1\u7406\r\n    <form>\r\n        <div>\r\n            <input type="button" value="\u6D41\u7A0B\u53D1\u5E03" ng-click="deployProcess()"/>\r\n            <input type="button" value="\u6D41\u7A0B\u5220\u9664" ng-click="deleteProcess()"/>\r\n        </div>\r\n        <div>\r\n            \u5F85\u542F\u52A8\u6D41\u7A0B\u7F16\u53F7<input type="input" ng-model="processId"/>\r\n            <input type="button" value="\u6D41\u7A0B\u542F\u52A8" ng-click="startProcess()"/>\r\n        </div>\r\n\r\n    </form>\r\n</div>');
$templateCache.put('app/module-process/tpl/processBpmn.html','<div ng-controller="ProcessController">\r\n    bpmn\u6587\u4EF6\uFF1A\r\n    <div>\r\n        <!--< href="http://localhost:8090/tlms-web/service/process/source/{{process.currPdid}}/{{process.resourceType}}"/>-->\r\n    </div>\r\n</div>');
$templateCache.put('app/module-process/tpl/processDetail.html','<div ng-controller="ProcessController">\r\n    \u6D41\u7A0B\u660E\u7EC6\r\n    <input type="button" value="\u8FD4\u56DE" ng-click="goBack()"/>\r\n    <input type="button" value="\u67E5\u770B\u6D41\u7A0B\u56FE" ng-click="readCurrDetailDgrmResource(process.processInstId)"/>\r\n    <input type="button" value="\u540C\u610F" ng-click="agree(process.processInstId)"/>\r\n    <div>\r\n        <div ui-view="dgmnView"></div>\r\n    </div>\r\n</div>');
